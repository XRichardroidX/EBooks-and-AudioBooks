...
Future<void> uploadBookToDatabase(String bookTitle, String authorName, String bookSummary) async {
  try {
    client
    ...
    Document response = await databases.createDocument(
      databaseId: AppWriteConstants.databaseId, // Replace with your database ID
